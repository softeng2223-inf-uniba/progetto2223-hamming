...
## 7. Manuale utente
La battaglia navale è un gioco, in questo caso a giocatore singolo, il cui obiettivo è quello di affondare tutte le tipologie di navi che sono posizionate su una griglia 10x10 nascosta al giocatore con le righe numerate da 1 a 10 e le colonne numerate da A a J.
...
La tipologie di navi si distinguono in base alla dimensione: 
