...
1. il testing del vostro codice (unit test con [JUnit](https://junit.org/)) e l'analisi dello stesso con strumenti di quality assurance ([PMD](https://pmd.github.io/), [Checkstyle](https://checkstyle.org/), [Spotbugs](https://spotbugs.github.io));
