...
1. il testing del vostro codice (unit test con [JUnit](https://junit.org/)) e l'analisi dello stesso con strumenti di quality assurance ([PMD](https://pmd.github.io/), [Checkstyle](https://checkstyle.org/) e [Spotbugs](https://spotbugs.github.io));
...
- Dopo l’esecuzione dei test è possibile lanciare gli strumenti di **Quality Assurance** (PMD, checkstyle e findbugs) per assicurarsi di aver scritto codice di qualità. Leggere la sezione *Controlli di Qualità* per ulteriori informazioni.
